package com.jshy.schedule.test;
...
//        cacheService.zAdd("zset_key_001","hello zset 004",999999);
    ...
    public void testKeys(){
        Set<String> keys = cacheService.keys("zset_key_*");
...
//使用管道技术执行100次自增操作共耗时:952毫秒
    ...
    public void testPiple2(){
        ...
        System.out.println("使用管道技术执行100次自增操作共耗时:"+(System.currentTimeMillis()-start)+"毫秒");
    }
